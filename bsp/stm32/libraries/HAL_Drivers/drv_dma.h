...
extern "C" {
	...
	|| defined(SOC_SERIES_STM32WB)	//by yangwensen@20201123
...
#if defined(SOC_SERIES_STM32L4) || defined(SOC_SERIES_STM32G0) || defined(SOC_SERIES_STM32G4) || defined(SOC_SERIES_STM32WB)
    rt_uint32_t request;
#endif
};
